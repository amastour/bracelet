...
class AuthController extends Controller {
	...
	public function postRegister(RegisterRequest $request)
	{
		if (config('access.users.confirm_email')) {
			$this->auth->create($request->only('username','first_name','last_name','password','tel','email'));
			return redirect()->route('home')->withFlashSuccess("Votre compte a été créé avec succès. Nous vous avons envoyé un e-mail pour confirmer votre compte.");
		} else {
